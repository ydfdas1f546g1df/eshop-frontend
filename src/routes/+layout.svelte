...
<TopAppBar bind:this={topAppBar} variant="standard">
    <Row>
        <Section>
            ...
            <Title on:click={() => window.location="/"}>Shop</Title>
        </Section>
        <Section toolbar id="end">
            <!-- Make a login button -->
            {#if usercookie}
                <IconButton on:click={() => window.location="/logout"} id="login">
                    <p>Logout</p>
                </IconButton>
            {:else}
                <IconButton on:click={() => window.location="/login"} id="logout">
                    <p>Login</p>
                </IconButton>
            {/if}
        </Section>
